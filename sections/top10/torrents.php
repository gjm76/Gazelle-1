...
<?php 	} ?>
    ...
    <tr class="colhead">
        ...
        <td class="top10 stat"><img src="static/styles/themes/<?=$LoggedUser['StyleName']?>/images/snatched.svg" alt="↺" title="Snatches" /></td>
        <td class="top10 stat"><img src="static/styles/themes/<?=$LoggedUser['StyleName']?>/images/seeders.svg" alt="∧" title="Seeders" /></td>
        <td class="top10 stat"><img src="static/styles/themes/<?=$LoggedUser['StyleName']?>/images/leechers.svg" alt="∨" title="Leechers" /></td>
...
<?php
    ...
    foreach ($Details as $Detail) {
        list($TorrentID,$GroupID,$GroupName, $NewCategoryID, $TorrentTags,
            $Snatched,$Seeders,$Leechers,$Data,$Size,$UploaderID,$UploaderName,,,$IsAnon,$FilePath,$Image) = $Detail;
...
<?php               } else {
                    $Overlay = get_overlay_html($GroupName, anon_username($UploaderName, $IsAnon), $Image, $Seeders, $Leechers, $Size, $Snatched,$FilePath);
                    ?>
                    <script>
