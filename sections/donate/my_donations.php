...
?>
    ...
    ?>
        ...
        When your transfer is verified you must return to this page and choose how to submit your donation (for -gb or <img src="<?= STATIC_SERVER ?>common/symbols/donor.svg" alt="love" />)<br/><br/>
    <?php
        if ($eur_rate=='0') {   ?>
            ...
            <div class="donate_details<?=($can_submit?' green':'')?>">
                ...
                if ($balance1>0) {
                    ...
                    <tr>
                        ...
                        ?>  <img src="<?= STATIC_SERVER ?>common/symbols/donor.svg" alt="Donor" />
                        </td>
                    </tr>
                    <?php
                }
