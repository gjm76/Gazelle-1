<?php
    ...
    $Text = new TEXT;
    if (!$_POST["connect"] || (!isset($_POST["ttn"]) && !isset($_POST["help"]) && !isset($_POST["staff"]))) {
?>
<div class="thin">
        ...
        <table>
            <tr>
                <td class="noborder right" width="60%">
                     connect to the <strong>#nbl</strong> general chat channel
                    <input type="checkbox" id="channel1" name="ttn" value="1" checked="checked" /><br/>
                     connect to the <strong>#nbl-support</strong> channel*
                    <input type="checkbox" id="channel2" name="help" value="1" />
<?php               if ($LoggedUser['SupportFor'] !="" || $LoggedUser['DisplayStaff'] == 1) { ?>
                    <br/> connect to the <strong>#nbl-staff</strong> channel*
                    <input type="checkbox" id="channel3" name="staff" value="1" />
<?php               } ?>
                </td>
                <td class="noborder">
                    <input type="submit" id="connect" name="connect" style="width:auto" value="I agree to the rules" />
                </td>
            </tr>
            <tr>
