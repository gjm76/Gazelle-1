          ...
          <table class="friends_table vertical_margin">
                ...
                <tr>
                      <td colspan="5">
                              ...
                              Adjust Cubits and Download do not send any PM themselves.<br/>
                              If you want to remove download (or cubits) use a '-' before the number and note the download amount is in GB. ie. '-1024' will remove 1 TB.
                      </td>
                </tr>
          </table>
    </form>
...
if ($Results == 0) {
    ...
    <?php 	if (check_paranoia('ratio', $Paranoia, $Class, $UserID) && check_perms('site_ratio')) { ?>
    ...
    <?php 	} ?>
    <?php 	if (check_paranoia('downloaded', $Paranoia, $Class, $UserID) && check_perms('site_downloaded')) { ?>
    ...
    <?php
          ...
          <?php 	} else { ?>
                            <img src="<?=STATIC_SERVER?>common/avatars/default.svg" width="50px" alt="Default avatar" />
          <?php 	}
          } ?>
                      </td>
                      <td valign="top">
