...
if (!empty($_REQUEST['action'])) {
    switch ($_REQUEST['action']) {
        ...
        case 'autocomplete':
            enforce_login();
            include(SERVER_ROOT.'/sections/torrents/autocomplete.php');
            break;
        ...
        case 'editshow':
            enforce_login();
            include(SERVER_ROOT.'/sections/shows/editshow.php');
            break;             
        ...
        case 'scrape':
            enforce_login();
            include(SERVER_ROOT.'/sections/torrents/scrape.php');
            break;

        case 'refresh':
            enforce_login();
            include(SERVER_ROOT.'/sections/shows/takeshowrefresh.php');
            break;

        case 'refresh_cache':
            enforce_login();
            include(SERVER_ROOT.'/sections/shows/takeshowrefreshcache.php');
            break;

        case 'refresh_person':
            enforce_login();
            include(SERVER_ROOT.'/sections/people/takepersonrefresh.php');
            break;

        case 'refresh_person_cache':
            enforce_login();
            include(SERVER_ROOT.'/sections/people/takepersonrefreshcache.php');
            break;
        ...
        case 'add_torrent_batch':
            enforce_login();
            include(SERVER_ROOT.'/sections/torrents/add_torrent.php');
            break;

        case 'scrape_torrents':
            enforce_login();
            include(SERVER_ROOT.'/sections/torrents/scrape_torrents.php');
            break;          

        case 'ratings':
            enforce_login();
            include(SERVER_ROOT.'/sections/shows/ratings.php');
            break; 

        case 'takemassdelete':
            enforce_login();
            include(SERVER_ROOT.'/sections/torrents/takemassdelete.php');
            break;

        case 'clearhnr':
            enforce_login();
            include(SERVER_ROOT.'/sections/torrents/clearhnr.php');
            break;
            
        case 'takemassdoubleseed':
            enforce_login();
            include(SERVER_ROOT.'/sections/torrents/takemassdoubleseed.php');
            break;

        case 'takemassundoubleseed':
            enforce_login();
            include(SERVER_ROOT.'/sections/torrents/takemassundoubleseed.php');
            break;

        case 'takemassfreeleech':
            enforce_login();
            include(SERVER_ROOT.'/sections/torrents/takemassfreeleech.php');
            break;

        case 'takemassdownload':
            enforce_login();
            include(SERVER_ROOT.'/sections/torrents/takemassdownload.php');
            break;
            
        case 'takemassunfreeleech':
            enforce_login();
            include(SERVER_ROOT.'/sections/torrents/takemassunfreeleech.php');
            break;
        ...
        case 'notify_handle': // for show page
            enforce_login();
            include(SERVER_ROOT.'/sections/shows/notify_handle.php');
            break;

        case 'notify_delete': // for show page
            enforce_login();
            include(SERVER_ROOT.'/sections/shows/notify_delete.php');        
            break;

        case 'follow_handle': // for show page
            enforce_login();
            include(SERVER_ROOT.'/sections/follows/add.php');
            break;

        case 'follow_delete': // for show page
            enforce_login();
            include(SERVER_ROOT.'/sections/follows/delete.php');        
            break;

        case 'rate': // for show page
            enforce_login();
            include(SERVER_ROOT.'/sections/shows/rate.php');        
            break;

        case 'unrate': // for show page
            enforce_login();
            include(SERVER_ROOT.'/sections/shows/unrate.php');        
            break;

        case 'refreshrating': // for show page
            enforce_login();
            include(SERVER_ROOT.'/sections/shows/refreshrating.php');        
            break;

        case 'calculate': // for show page
            enforce_login();
            include(SERVER_ROOT.'/sections/shows/calculate.php');        
            break;
        ...
        case 'show':
            enforce_login();
            include(SERVER_ROOT.'/sections/shows/show.php');            
            break;

        case 'person':
            enforce_login();
            include(SERVER_ROOT.'/sections/people/person.php');            
            break;
   ...
   // Review system (Marked for deletion)
        ...
        default:
            ...
            if (!empty($_GET['id'])) {
                ...
                include(SERVER_ROOT.'/sections/torrents/browse_shows.php');
            }
            break;
    }
} else {
