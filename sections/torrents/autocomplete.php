...
$AutoSuggest = $Cache->get("autocomplete_{$KeySize}_$Letters");
...
if (!$AutoSuggest) {
  ...
  $Cache->cache_value("autocomplete_{$KeySize}_$Letters", $AutoSuggest, 1800 + 7200 * ($MaxKeySize - $KeySize)); // Can't cache things for too long in case names are edited
}
