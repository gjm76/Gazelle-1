...
?>
    <div>
        <p class="stronger">IMPORTANT: <?=SITE_URL?> is a private tracker.
    ...
    <table cellpadding="2" cellspacing="1" border="0" align="center">
        <tr valign="top">
            ...
            <td align="left">
                ...
                <p style="padding: 10px">We recommend that you do NOT use your real name in the interest of personal security!<br>Personal domains are not permitted.</p>
            </td>
        </tr>
        <tr valign="top">
