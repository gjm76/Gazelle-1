...
?>
<div class="thin">
    <h2><?php if ($BookmarkView) { ?><img src="static/styles/themes/<?= $LoggedUser['StyleName'] ?>/images/bookmarked.svg" alt="star" title="Bookmarked collages" /><?php } ?> &nbsp;Collages</h2>
<?php if (!$BookmarkView) { ?>
...
<?php		} else { ?>
        <em> <a href="articles.php?topic=collages">You must be <span style="color:#4fc986">Nugget</span> class or above to be able to create a collage.</a></em><br/>
<?php          }
