...
if ($Results == 0) {
    ...
    <?php 	if (check_paranoia('ratio', $Paranoia, $Level, $FriendID) && check_perms('site_ratio')) { ?>
    ...
    <?php 	} ?>
    <?php 	if (check_paranoia('downloaded', $Paranoia, $Level, $FriendID) && check_perms('site_downloaded')) { ?>
