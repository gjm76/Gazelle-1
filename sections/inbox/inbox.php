...
<?php 			} ?>
                ...
                <br />
                <input type="text" name="search" value="Search <?= ($Section == 'sentbox') ? 'Sentbox' : 'Inbox' ?>" style="width: 99.2%;"
...
<?php
        if ($Unread) { echo '</strong>';} ?>
                    ...
                    <td><?=format_username($SenderID, $Username, false, true, $Enabled, $ClassID, false, false, $GroupPermID)?></td>
