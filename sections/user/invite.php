...
if(!$Sneaky
    ...
    <div class="box pad">
        <div><strong>Rules for Giving out <?=SITE_NAME?> Invites:</strong><br/><br/>
            <strong style="color: green">DOs</strong><br/>
            <ul>
                <li>Do give away your invites on the class-restricted invite forums of reputable private trackers</li>
                <li>Do give your invites to personal friends who you think will be a positive addition to our community</li>
                <li>Do give away your invites to people who you've known for a long time and think will be a positive addition to <?=SITE_NAME?></li>
            </ul>
            <br/>
            <br/>
            ...
            <ul>
                ...
                <li>Don't give your invites to anyone who already had an <?=SITE_NAME?> account in the past.</li>
            ...
            <br/>
            <strong>The rules, especially the <span style="color: red">DON'Ts</span> part, will have consequences for your account.</strong><br/><br/>
            ...
            If you should notice that somewhere <?=SITE_NAME?> invites are be given out not following the rules, we would appreciate it if you could write a Staff PM to us about it. We unfortunately can not continuously watch all the places allowing such behaviour.
        </div>
    </div>
    <div class="box pad">
