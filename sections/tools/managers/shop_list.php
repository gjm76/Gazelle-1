...
<div class="box pad">
    You can use this tool to automatically update the black market with badge items.<br />
    It will remove all the current badge items from the black market (if the checkbox is checked), then select from the badge table all badges with 'Shop' type set and insert them.<br />
