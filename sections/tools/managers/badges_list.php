...
<?php                       print_select_image($ID); ?>
                    ...
                    <td>
                        <input class="medium" type="text" name="cost[<?=$ID?>]" id="cost<?=$ID?>" value="" onchange="Set_Edit('<?=$ID?>')" title="Cost (Only used if item is a Black Market or donor badge)"/>
                    </td>
                </tr>
                <tr class="rowa">
...
<?php           }       ?>
    ...
    <div class="box pad">
        ...
        <ul>
            ...
            <li>Shop     = Can be bought in Black Market *** (needs a seperate entry in bonus_shop_actions to appear in Black Market - this value is used to both build that entry automatically and filters the entry from other actions.</li>
        </ul>
        All badges except those with 'Black Market' type can be awarded by staff (who have 'users_edit_badges' permission)<br /><br />
        <h3>Sort</h3>
        ...
        <ul>
            ...
            <li>To add 'Black Market bar' type badges to the Black Market use the <a href="/tools.php?action=shop_list">Black Market Manager</a></li>
        </ul>
    </div><br/>
...
<?php                           } ?>
                    ...
                    <td>
                        <input class="medium" type="text" name="cost[<?=$ID?>]" value="<?=display_str($Cost)?>" onchange="Set_Edit(<?=$ID?>)" title="Cost (Only used if item is a Black Market or donor badge)"/>
                    </td>
                </tr>
                <tr class="rowa">
                    <td colspan="10" class="noborder"></td>
