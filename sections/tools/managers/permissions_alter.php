...
<?php if ($IsUserClass) {     ?>
        ...
        <tr>
            ...
            <td><input type="text" name="requploaded" id="requploaded" title="GB" value="<?=(!is_null($reqUploaded) ? display_str($reqUploaded/pow(1024,3)) : '')?>" /></td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="label">Req Snatches</td>
            <td><input type="text" name="reqsnatches" id="reqsnatches" title="Max: 65535" value="<?=(!is_null($reqSnatches) ? display_str($reqSnatches) : '')?>" /></td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="label">Req Cubits</td>
            <td><input type="text" name="reqcredits" id="reqcredits" title="Cubits for promotion" value="<?=(!is_null($reqCredits) ? display_str(number_format($reqCredits, 2, '.', '')) : '')?>" /></td>
        </tr>        <tr>
