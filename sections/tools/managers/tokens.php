...
if (isset($_REQUEST['addtokens'])) {
    ...
    $message = "<strong>$Tokens freeleech tokens set to all enabled users" . (!isset($_REQUEST['leechdisabled'])?' with enabled leeching privs':'') . '.</strong><br /><br />';
    $where = "";
}
...
<div class="box pad" style="margin-left: auto; margin-right: auto; text-align:center; max-width: 40%">
    <form action="" method="post">
        ...
        <input type="submit" name="addtokens" value="Add tokens" onclick="jQuery('#messagebarA').addClass('hidden');">
    </form>
</div>
<br />
<div class="box pad" style="margin-left: auto; margin-right: auto; text-align:center; max-width: 40%">
    <form action="" method="post">
        ...
        <input type="submit" name="cleartokens" value="Set token total" onclick="jQuery('#messagebarA').addClass('hidden');">
    </form>
</div>
</div>
<?php
