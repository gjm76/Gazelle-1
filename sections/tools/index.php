...
switch ($_REQUEST['action']) {
    ...
    case 'automatic_banners':
        include(SERVER_ROOT . '/sections/tools/managers/banners_list.php');
        break;

    case 'ba_alter':
        include(SERVER_ROOT . '/sections/tools/managers/banners_alter.php');
        break;

    case 'automatic_codecs':
        include(SERVER_ROOT . '/sections/tools/managers/codecs_list.php');
        break;

    case 'cx_alter':
        include(SERVER_ROOT . '/sections/tools/managers/codecs_alter.php');
        break;

    case 'automatic_parser':
        include(SERVER_ROOT . '/sections/tools/managers/parser_list.php');
        break;

    case 'parser_alter':
        include(SERVER_ROOT . '/sections/tools/managers/parser_alter.php');
        break;

    case 'parser_test':
        include(SERVER_ROOT . '/sections/tools/managers/parser_test.php');
        break;
    ...
    case 'reasons':
        include(SERVER_ROOT . '/sections/tools/managers/reasons_list.php');
        break;

    case 'reasons_alter':
        include(SERVER_ROOT . '/sections/tools/managers/reasons_alter.php');
        break;
        
    case 'networks':
        include(SERVER_ROOT . '/sections/tools/managers/networks_list.php');
        break;

    case 'shows':
        include(SERVER_ROOT . '/sections/tools/managers/shows.php');
        break;

    case 'clear_shows':
        include(SERVER_ROOT . '/sections/tools/managers/takeshowsclear.php');
        break;
                
    case 'premiers':
        include(SERVER_ROOT . '/sections/tools/managers/premiers.php');
        break;

    case 'miscfixers':
        include(SERVER_ROOT . '/sections/tools/managers/miscfixers.php');
        break;

    case 'featured_show':
        include(SERVER_ROOT . '/sections/tools/managers/featured_show_list.php');
        break;

    case 'featured_show_alter':
        include(SERVER_ROOT . '/sections/tools/managers/featured_show_alter.php');
        break;
    ...
    case 'tokens':
        ...
        break;
    case 'invites':
        include(SERVER_ROOT . '/sections/tools/managers/invites.php');
        break;        
    case 'ocelot':
    ...
    case 'official_synonyms_alter':
        ...
        break;
    case 'tags_exceptions':
        include(SERVER_ROOT . '/sections/tools/managers/tags_exceptions.php');
        break;
    case 'tags_exceptions_alter':
        include(SERVER_ROOT . '/sections/tools/managers/tags_exceptions_alter.php');
        break;
        ...
        if (!empty($_REQUEST['id'])) {
            ...
            if (is_numeric($_REQUEST['id'])) {
                $DB->query("SELECT p.ID,p.Name,p.Description,p.Level,p.Values,p.DisplayStaff,p.IsUserClass,
                                   ...
                                   p.isAutoPromote,p.reqWeeks,p.reqUploaded,p.reqTorrents,p.reqForumPosts,p.reqRatio,p.reqCredits,p.reqSnatches,
                                   p.Color
                              FROM permissions AS p WHERE p.ID='" . db_string($_REQUEST['id']) . "' ");
                list($ID, $Name, $Description, $Level, $Values, $DisplayStaff, $IsUserClass, $MaxSigLength, $MaxAvatarWidth, $MaxAvatarHeight, 
                $isAutoPromote, $reqWeeks, $reqUploaded, $reqTorrents, $reqForumPosts, $reqRatio, $reqCredits, $reqSnatches, $Color) = 
                $DB->next_record(MYSQLI_NUM, array(4));
            ...
            if (!empty($_POST['submit'])) {
                ...
                if ($IsUserClass) {
                    ...
                    $reqUploaded     = $_REQUEST['requploaded']*pow(1024,3);
                    $reqTorrents     = $_REQUEST['reqtorrents'];
                    $reqSnatches     = $_REQUEST['reqsnatches'];
                    $reqForumPosts   = $_REQUEST['reqforumposts'];
                    $reqRatio        = $_REQUEST['reqratio'];
                    $reqCredits      = $_REQUEST['reqcredits'];
                ...
                if (!$Err) {
                    if (!is_numeric($_REQUEST['id'])) {
                        $DB->query("INSERT INTO permissions
                                            (Level,Description,Name,`Values`,DisplayStaff,IsUserClass,MaxSigLength,MaxAvatarWidth,MaxAvatarHeight,
                                            isAutoPromote,reqWeeks,reqUploaded,reqTorrents,reqForumPosts,reqRatio,reqCredits,reqSnatches,Color)
                                     VALUES ('" . db_string($Level)
                                        ...
                                        . "','" . db_string($reqRatio)
                                        . "','" . db_string($reqCredits)
                                        . "','" . db_string($reqSnatches)
                                        . "','" . db_string($Color) . "')");
                    } else {
                        $DB->query("UPDATE permissions SET Level='" . db_string($Level)
                           ...
                           . "',reqCredits='" . db_string($reqCredits)
                           . "',reqSnatches='" . db_string($reqSnatches)
    ...
    //Data
    case 'ratings':
        include(SERVER_ROOT . '/sections/tools/data/ratings.php');
        break;
   ...
   case 'delete_addresses':
    ...
    case 'hnr_pool':
        include(SERVER_ROOT . '/sections/tools/data/hnr_pool.php');
        break;
    ...
    case 'flush_ip_history':
        include(SERVER_ROOT . '/sections/tools/misc/flush_ip_history.php');
        break;
    ...
    case 'get_post':
        include(SERVER_ROOT . '/common/get_post.php');
        break;
        
    case 'allcomments':
        include(SERVER_ROOT . '/sections/torrents/all_comments.php');
        break;
