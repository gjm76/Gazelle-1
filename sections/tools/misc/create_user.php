...
if (!empty($_POST['submit'])) {
    ...
    $Enabled = '1';
    $DB->query("INSERT INTO users_main (Username,Email,PassHash,Secret,torrent_pass,Enabled,
                                        PermissionID,Uploaded,Invites,FLTokens,personal_freeleech)
