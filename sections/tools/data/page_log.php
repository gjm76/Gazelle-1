        ...
        <form action="tools.php" method="post">
            ...
            <table class="shadow">
                <tr>
                    ...
                    <td colspan="3">
                        <select name="logging">
                            <option value="0" <?php  if ($SiteOptions['FullLogging']=='0') echo 'selected="selected"' ;?>>Off</option>
                            <option value="1" <?php  if ($SiteOptions['FullLogging']=='1') echo 'selected="selected"' ;?>>Only user.php</option>
                            <option value="2" <?php  if ($SiteOptions['FullLogging']=='2') echo 'selected="selected"' ;?>>Nearly All (excludes some common known ajax calls)</option>
                            <option value="3" <?php  if ($SiteOptions['FullLogging']=='3') echo 'selected="selected"' ;?>>Absolutely All</option>
                        </select>
