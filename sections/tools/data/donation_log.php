...
// generate a graph of monthly donations (last 2 years)
...
show_header('Donation log','bitcoin,flot/excanvas,flot/jquery.flot.min,flot/jquery.flot.time');
?>
<div class="thin">
    <h2>Donation log</h2>
<?php
...
?>
    ...
    <?php                   if ($numthispage>0) {      ?>
                            ...
                            <a style="cursor: pointer;" onclick="CheckAddressLoadNext('1','<?=$eur_rate?>','6','<?=$numthispage?>','<?=($unused?'0':'1')?>');"><img src="<?= STATIC_SERVER ?>common/symbols/reload1.svg" alt="query" /></a> &nbsp;
                    ...
                    <td>
                        <span style="font-style: italic;" id="btc_button_<?=$i?>">
                            <a href="#" onclick="CheckAddress('<?=$i?>','<?=$eur_rate?>','<?=$public?>','6','<?=($unused?'0':'1')?>');return false;">
                                <img src="<?= STATIC_SERVER ?>common/symbols/reload1.svg" title="query btc balance" alt="query" /></a>
                        </span>&nbsp;
