    ...
    if (!$NumResults) {
        ...
        <?php  if (!$LoggedUser['HideCollage']) { ?>
                ...
                <?php  } ?>
                    ...
                    <td>Size</td>
                    <td><img src="static/styles/themes/<?= $LoggedUser['StyleName'] ?>/images/snatched.svg" alt="↺" title="Snatches" /></td>
                    <td><img src="static/styles/themes/<?= $LoggedUser['StyleName'] ?>/images/seeders.svg" alt="∧" title="Seeders" /></td>
