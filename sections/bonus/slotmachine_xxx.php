...
if (!check_perms( 'site_play_slots')) error ("You do not have permission to play the TtN slot machine!");
...
<div class="thin">
    <h2> “Sometimes, you have to roll a hard six.” </h2>

    <div style="float:right;width:260px;margin:15px">
    ...
    <div class=" " style="position:relative;width:604px;margin:20px 330px 50px auto;">
        ...
        <div class="box pad">
            <table id="fmtop" class=" fm" >
                <tr>
                    ...
                    <td class="noborder center" style="width:50%;"><h3 id="result" style="color:#54C571;font-size:2.0em"></h3></td>
                    <td class="label noborder">Cubits:</td>
                    <td class="noborder"><span style="float:right;font-size:medium" id="winnings"><?=number_format($LoggedUser['TotalCredits'])?></span></td>
                </tr>
            </table>
        </div>
        <div class="box pad shadow">
            ...
            <br/>
            <a href="#" style="position:absolute;right:-80px;top:122px;" onclick="Pull_Lever(); return false">
                <img id="lever" src="<?=STATIC_SERVER?>common/casino/leverUp.png" />
            </a>
            <div id="beta" class="chip hidden" style="top:105px;"></div>
            <div id="betb" class="chip" style="top:207px;"></div>
            <div id="betc" class="chip hidden" style="top:308px;"></div>
        </div>
