...
?>
        ...
        <div class="box">
            <div class="pad" id="bonusdiv">
                <h4 class="center">Cubits: <?=(!$BonusCredits ? '0.00' : number_format($BonusCredits,2))?></h4>
    ...
    <div class="head">Special Gift</div>
        ...
        <table class="bonusshop">
            ...
            <tr>
                <td>
                    <select name="class">
                        <option value="<= <?=$Classes[FREELANCER]['Level']?>">any</option>
                        <option value="= <?=$Classes[RESEARCHER]['Level']?>">Researcher</option>
                        <option value="<= <?=$Classes[DESIGNER]['Level']?>">Designer or lower</option>
                        <option value="<= <?=$Classes[PRESENTER]['Level']?>">Presenter or lower</option>
                        <option value=">= <?=$Classes[PUBLICIST]['Level']?>">Publicist or higher</option>
                        <option value=">= <?=$Classes[EDITOR]['Level']?>">Editor or higher</option>
                    </select>
                </td>
                <td>
                    <select name="ratio">
            ...
            <tr>
                <td colspan=4, class="center">
                    <br />
                    <strong>Send a gift to a random member matching your selected criteria</strong>
                </td>
            </tr>
        </table>
        <table>
