...
foreach ($CollageDataList as $GroupID=>$Group) {
    ...
    list($GroupID2, $Image, $NewCategoryID, $BookmarkDate, $UploadDate, ,$TVMAZE) = array_values($CollageDataList[$GroupID]);
...
<?php            } ?>        
                ...
                <img src="<?= $CatImg ?>" alt="<?= $NewCategories[$NewCategoryID]['tag'] ?>" title="<?php echo empty($TVMAZE) ? $NewCategories[$NewCategoryID]['tag'] : 'Go to show'; ?>"/>
<?php            if($TVMAZE) { ?>
                  </a> 
<?php            } ?>                
        </td>
...
?>
<div class="thin">
    <h2><img src="static/styles/themes/<?= $LoggedUser['StyleName'] ?>/images/bookmarked.svg" alt="star" title="Bookmarked torrents" /> &nbsp;Bookmarks</h2>
    <div class="linkbox">
...
<?php	}
		...
		<td><a href="<?=header_link('Size') ?>">Size</a></td>
                <td class="sign"><a href="<?=header_link('Snatched') ?>"><img src="static/styles/themes/<?=$LoggedUser['StyleName'] ?>/images/snatched.svg" alt="↺" title="Snatches" /></a></td>
