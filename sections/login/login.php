...
<?php  } ?>
    <table>
        ...
        <tr>
            <td width="70px">Two-factor&nbsp;</td>
            <td width="200px" colspan="2"><input style="width: 98%;" type="text" name="twofa" id="twofa" class="inputtext" maxlength="6" pattern="[0-9]{6}" title="Leave blank if you have not enabled 2FA" /></td>
        </tr>
        <tr>
            <td width="70px"></td>
            <td width="150px">
...
?>
    <br /><br />
    <span style="font-size:1em">Lost your password? </span><span style="font-size:1em" color="red"><a href="login.php?act=recover">Recover it here!</a></span>
<?php  } ?>
