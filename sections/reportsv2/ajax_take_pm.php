...
if ($Recipient == 'Uploader') {
    ...
    if ($Report) {
        $Message = "You uploaded [url=http://".SSL_SITE_URL."/torrents.php?torrentid=".$TorrentID."]this torrent[/url], it has been reported for the reason: ".$ReportType['title']."\n\n".$Message;
    } else {
        $Message = "I am PMing you as you are the uploader of [url=http://".SSL_SITE_URL."/torrents.php?torrentid=".$TorrentID."]this torrent[/url].\n\n".$Message;
    }
