...
show_header('Reports V2!', 'reportsv2,bbcode,inbox,reports');
include 'header.php';
...
<?php
        ...
        ?>
            ...
            <?php   } else {
                                ...
                                &nbsp;(<?=str_plural('file',$Filecount)?>)&nbsp;[ <span title="Seeders"><?=$PeerInfo['Seeders']?> <img src="static/styles/themes/<?=$LoggedUser['StyleName'] ?>/images/seeders.svg" alt="seeders" title="seeders" /></span> | <span title="Leechers"><?=$PeerInfo['Leechers']?> <img src="static/styles/themes/<?=$LoggedUser['StyleName'] ?>/images/leechers.svg" alt="leechers" title="leechers" /></span> ]
            ...
            <?php
                    ...
                    foreach ($Extras as $ExtraID) {
                        ...
                        if ($ExtraGroupName) {
                            ...
                            &nbsp;(<?=str_plural('file',$ExtraFilecount)?>)&nbsp;[ <span title="Seeders"><?=$ExtraPeerInfo['Seeders']?> <img src="static/styles/themes/<?=$LoggedUser['StyleName'] ?>/images/seeders.svg" alt="seeders" title="seeders" /></span> | <span title="Leechers"><?=$ExtraPeerInfo['Leechers']?> <img src="static/styles/themes/<?=$LoggedUser['StyleName'] ?>/images/leechers.svg" alt="leechers" title="leechers" /></span> ]
