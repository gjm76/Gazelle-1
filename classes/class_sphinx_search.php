...
class SPHINX_SEARCH extends SphinxClient
{
    ...
    ****************************************************************/
    public function search($Query='', $CachePrefix='', $CacheLength=0, $ReturnData=array(), $SQL = '', $IDColumn='ID')
    {
        ...
        $this->Queries[]=array('Params: '.$Query.' Filters: '.implode(", ", $Filters).' Indicies: '.$this->Index,($QueryEndTime-$QueryStartTime)*1000, $Result);
    ...
    public function limit($Start, $Length, $MaxMatches=SPHINX_MATCHES_START)
    {
